<main class="container-fluid">
    ...
    <section class="box w-sm">
        ...
        <form action="" method="post">
            ...
            <input class="form-control" type="hidden" name="user_id" value="<?= $user_id ?>" id="user_id" placeholder="*************" maxlength="99" required>
            <!-- Champ caché timestamp -->
            <label class="d-none" for="timestamp">Timestamp</label>
            <input class="form-control" type="hidden" name="timestamp" value="<?= $timestamp ?>" id="timestamp" placeholder="*************" maxlength="99" required>
            <!-- Mot de passe -->
            ...
            <input class="form-control" type="password" name="password-verif" id="password-verif" placeholder="*************" maxlength="99" required>
            <hr>
