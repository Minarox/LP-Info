                    ...
                    <tbody>
                        <?php if (permissions("SELECT", $permissions)): ?>
                            <?php foreach ($data as $row) : ?>
                                <tr>
                                    <td class="cw-45 checkbox"><input type="checkbox" name="row[]" value="<?= $row['club_id']."-".$row['item_id'] ?>"></td>
                                    <td><?= $row['club_id'] ?></td>
                                    <td><?= $row['item_id'] ?></td>
                                    <td><?= $row['quantity'] ?></td>
                                    <?php if (permissions("UPDATE", $permissions)): ?>
                                        <td class="cw-100 action"><a href="<?= ROOT ?>club/items/form?club_id=<?= $row['club_id'] ?>&item_id=<?= $row['item_id'] ?>"><input type="button" value="Editer"></a></td>
                                    <?php endif; ?>
                                </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
            ...
            <div class="actions-container">
                <div>
                    <?php if (permissions("INSERT", $permissions)): ?>
                        <a href="<?= ROOT ?>club/items/form"><input type="button" name="add" value="Ajouter"></a>
                    <?php endif; ?>
